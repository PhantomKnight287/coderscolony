...
export function Sidebar() {
  ...
  const openWarningModal = () =>
    openConfirmModal({
      ...
      children: (
        <>
          Creating A New Forums means running it actively and keeping an eye
          over activity of the users. Duplicate Forums will be deleted as it
          makes it hard for users to find the right information.
        </>
      ),
      labels: {
        cancel: "Cancel",
